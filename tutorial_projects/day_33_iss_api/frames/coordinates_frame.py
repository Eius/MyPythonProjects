...
from frames.master_frame import MasterFrame
...
class CoordinatesFrame(MasterFrame):
    def __init__(self, master, global_data: GlobalData):
        super().__init__(master, global_data)
        self.style = CoordinateFrameStyle()
    ...
    def update_loop(self):
        ...
        print(self.global_data.is_night())
