...
class CredentialsWindow(Toplevel):
    def __init__(self, website: str, username: str, password: str):
        ...
        self.username_label = tk.Label(self, text=f"Username:", font=self.style["font_bold"])
        self.password_label = tk.Label(self, text=f"Password:", font=self.style["font_bold"])

        self.copy_username_button = tk.Button(self, text="Copy Username", command=self.copy_username, width= 20)
        self.copy_password_button = tk.Button(self, text="Copy Password", command=self.copy_password, width= 20)
